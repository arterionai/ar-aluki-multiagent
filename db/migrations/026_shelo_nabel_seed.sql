...
-- Creates the Sheló NABEL ORGANIZATION tenant and adds the two authorized
-- WhatsApp numbers (14252307522 / 525528571249) as members so they can be
-- granted access to the SheloNabelDomainAgent without manual DB surgery.
...
BEGIN
    ...
    FROM users_profile
    WHERE external_auth_id = '14252307522';
    ...
    WHERE tenant_id = v_tenant_id
      AND context_type = 'DM'
      AND external_context_id = '14252307522';
    ...
    FROM users_profile
    WHERE external_auth_id = '525528571249';
    ...
    WHERE tenant_id = v_tenant_id
      AND context_type = 'DM'
      AND external_context_id = '525528571249';
