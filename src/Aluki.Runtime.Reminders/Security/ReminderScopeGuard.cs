...
namespace Aluki.Runtime.Reminders.Security;

/// <summary>
/// Validates that a supplied principal scope is real and authorized before any
/// reminder side effect: active tenant membership, and (when a context is
/// supplied) active context access. Mirrors
/// <see cref="Aluki.Runtime.Extraction.Security.ExtractionScopeGuard"/>.
/// </summary>
public sealed class ReminderScopeGuard
{
    private readonly NpgsqlConnectionFactory _connectionFactory;

    public ReminderScopeGuard(NpgsqlConnectionFactory connectionFactory)
    {
